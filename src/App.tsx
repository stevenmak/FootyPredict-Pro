    ...
    <div className="min-h-screen font-sans bg-[#0B0F19] text-slate-200 flex flex-col items-center">
          ...
          <div className="text-right">
            ...
            <div className="text-sm font-mono font-bold text-white flex items-center gap-1.5">
              {results ? (
                ...
                <span className="text-slate-600 uppercase">Awaits Input</span>
              )}
            </div>
          </div>
        </div>
      ...
      <nav className="fixed bottom-0 w-full max-w-lg bg-[#161B29]/95 backdrop-blur-2xl border-t border-slate-800 px-10 py-6 flex justify-between items-center z-30 shadow-[0_-10px_40px_rgba(0,0,0,0.4)]">
        <button className="flex flex-col items-center gap-2 group">
          <div className="p-2 rounded-xl group-hover:bg-emerald-500/10 transition-all text-emerald-500">
            <TrendingUp size={22} />
          </div>
          <span className="text-[9px] font-black uppercase tracking-widest text-emerald-500">Analytics</span>
        </button>
        <button className="flex flex-col items-center gap-2 group">
          <div className="p-2 rounded-xl group-hover:bg-white/5 transition-all text-slate-500">
            <History size={22} />
          </div>
        ...
        <button className="flex flex-col items-center gap-2 group">
          ...
          <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">Leagues</span>
        </button>
      </nav>
    </div>
  );
